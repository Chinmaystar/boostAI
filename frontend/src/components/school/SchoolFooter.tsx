...
export default function SchoolFooter() {
  return (
    <footer className="w-full bg-[#252323] pt-32 pb-16" style={{ paddingLeft: "120px", paddingRight: "120px" }}>
      <div className="max-w-[1200px] mx-auto flex flex-col items-center">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 text-[#9A9898] text-[13px]">
          ...
          <div className="md:w-1/3 text-right md:text-left leading-relaxed">
            <p>IBO, AQA, Pearson, OCR or WJEC were not involved in the production of, and do not endorse, the resources or AI tutoring provided on the BoostAI Platform.</p>
          </div>
          ...
          <div className="md:w-auto flex flex-wrap justify-center gap-6 md:gap-8 text-[13px]">
            ...
            <a href="#" className="hover:text-white transition-colors">Bursary</a>
            <a href="#" className="hover:text-white transition-colors">Cost comparison</a>
          </div>
